...
{
    @Override
    public void write(Jcodec jcodec, OutputView output, Character value)
    {
        output.writeChar(value);
    }

    @Override
    public Character read(Jcodec jcodec, InputView input, Class<? extends Character> typeClass)
    {
