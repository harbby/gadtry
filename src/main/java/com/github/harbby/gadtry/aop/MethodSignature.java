...
public class MethodSignature
{
    ...
    public static MethodSignature ofByGadtryAop(Method method)
    {
        //checkArgument(method.getName().startsWith(METHOD_START), "This method is not generated by gadtry aop");
        if (method.getName().startsWith(METHOD_START)) {
            return new MethodSignature(method, method.getName().substring(METHOD_START.length()));
        }
        else {
            return of(method);
        }
