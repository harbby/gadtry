...
public final class JDKProxy<T>
        implements CutMode<T>
{
    private final Class<T> interfaces;
    private final T instance;

    private JDKProxy(Class<T> interfaces, T instance)
    {
        this.interfaces = interfaces;
        this.instance = instance;
    }

    public static <T> JDKProxy<T> of(Class<T> interfaces, T instance)
    {
        return new JDKProxy<>(interfaces, instance);
    }

    @SuppressWarnings("unchecked")
    @SafeVarargs
    private final T getProxy(InvocationHandler handler, Class<T>... interfaces)
    {
